...
class MemberTest(BaseTest):
    ...
    def test_get_member_details(self):
        ...
        response = self.client.get(urlhelpers.member_update_url(self.shop.uuid, member.uuid))
        # print(json.dumps(response.data, indent=4))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_update_member(self):
        ...
        response = self.client.patch(urlhelpers.member_update_url(self.shop.uuid, member.uuid), update_payload)
        # print (json.dumps(response.data, indent=4))
    ...
    def test_delete_member(self):
        ...
        response = self.client.delete(urlhelpers.member_update_url(self.shop.uuid, member.uuid))
