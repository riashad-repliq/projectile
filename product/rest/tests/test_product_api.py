...
class ProductTest(BaseTest):
    ...
    def test_create_product(self):
        ...
        response = self.client.post(urlhelpers.product_create_url(self.shop.uuid), payload )
    ...
    def test_delete_product(self):
        ...
        response = self.client.delete(urlhelpers.product_update_url(self.shop.uuid, product.uuid))
