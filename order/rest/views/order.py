...
from order.rest.serializers.order import OrderSerializer, OrderItemSerializer, OrderItemReviewSerializer
...
class OrderItemManageView(RetrieveUpdateDestroyAPIView):
    ...
    def get_object(self):
        ...
        order_item = get_object_or_404(OrderItem, uuid=order_item_uuid, order__user = self.request.user )
